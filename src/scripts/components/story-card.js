...
export const createStoryCard = (story) => {
  ...
  card.innerHTML = `
    ...
    <div class="story-content">
      ...
      <div class="story-actions">
        ...
        <button id="likeButton-${storyId}" class="like-button" aria-label="Add to favorites">
          ${unlikeIcon}
        </button>
      </div>
    </div>
  ...
  const updateLikeButton = (liked) => {
    ...
    likeButton.style.color = liked ? 'red' : 'inherit';
  };
